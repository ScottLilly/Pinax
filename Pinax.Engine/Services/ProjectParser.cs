...
using Pinax.Engine.Common;
using Pinax.Engine.Models;
using Pinax.Engine.Models.Projects;
using Pinax.Engine.Models.ProjectTypes;
        ...
        foreach (XElement itemGroup in itemGroups)
        {
            ...
            foreach (XElement packageReference in packageReferences)
            {
                packages.Add(new Package
                {
                    ...
                    RawVersion = packageReference.GetValue("Version"),
                    VersionInUse = packageReference.GetValue("Version").ToVersion()
                });
            }
        }
